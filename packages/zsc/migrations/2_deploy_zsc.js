...
var ZVerifier = artifacts.require("ZVerifier");
...
module.exports = (deployer) => {
    return Promise.all([
        ...
        deployer.deploy(InnerProductVerifier, { gas: 6721975 }).then(() => Promise.all([
            deployer.deploy(ZVerifier, InnerProductVerifier.address, { gas: 6721975 }),
            deployer.deploy(BurnVerifier, InnerProductVerifier.address, { gas: 6721975 })
        ]))
    ]).then(() => deployer.deploy(ZSC, CashToken.address, ZVerifier.address, BurnVerifier.address, 6));
}